...
function detailNilai(id){
	$.ajax({
		url:'<?php echo site_url('admin/getNilaiUas'); ?>',
		type:'get',
		data:{id:id},
		dataType:'json',
		beforeSend:function(){
		...
		$("#detailJudul").html("Detail Nilai UAS");
...
$(function(){
	...
	$("#konfirmHapus").click(function(){
		...
		$.ajax({
			url:'<?php echo site_url("admin/hapusNilaiUAS"); ?>',
			type:'post',
			data:data,
			dataType:'json'
		}).done(function(data){
	...
	$("#modalTambahNilai [name='kd_kelas'],#modalSetting [name='kd_kelas']").change(function(e){
		...
		$.ajax({
			url:'<?php echo site_url('admin/getSiswaByKelas'); ?>',
			type:'get',
	...
	$("#modalLog").on("hidden.bs.modal",function(e){
		if($("body").data("isRefresh")==true)window.location.reload();
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Nilai UAS
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<div class="col-lg-6">
				 <form class="form-inline" id="gantiPaging" method="post" action="<?php echo site_url("admin/gantiPagingNilaiUas"); ?>">
			...
			<form id="frmCari" method="get" action="<?php echo site_url("admin/dataNilaiUAS"); ?>">
			 <div class="col-lg-4">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
								   ...
								   foreach($dataNilaiUAS as $data){
									   ...
									   if($hakAkses=="guru" || in_array($data->kd_mapel,$mapelYangDiajar))echo "<a href=\"#\" onclick=\"return editNilai('".$data->id."')\"><span class=\"glyphicon glyphicon-pencil\"></span> Edit</a> | <a href=\"#\" onclick=\"return hapusNilai('".$data->id."')\"><span class=\"glyphicon glyphicon-trash\"></span> Hapus</a> | ";
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalTambahNilai">
  <div class="modal-dialog">
	...
	<form id="frmTambahNilai" method="post" action="<?php echo site_url("admin/submitNilaiUAS"); ?>">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Input Nilai UAS</h4>
      </div>
...
<div class="form-group">
    <label class="lblNilai">Nilai UAS</label>
	<div class="row">
	<div class="col-sm-6" >
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalEditNilai">
  <div class="modal-dialog">
    <div class="modal-content">
	<form id="frmeditNilai" method="post" action="<?php echo site_url("admin/editNilaiUas"); ?>">
	<input type="hidden" name="idEdit" value="">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Edit Nilai UAS</h4>
      </div>
      <div class="modal-body">
        <p>
  <div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalSetting">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
	<form method="post" action="<?php echo site_url("admin/gantiPagingNilaiUas"); ?>" >
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<?php echo $nisData; ?>
  ...
  <div class="form-group">
	...
	<option value="00">Semua Mapel yang Diajar</option> 
<?php echo $mapelData2; ?>
</select>
</div>
<div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalDetail">
 ...
 <tr><td>Nilai UAS</td><td>:</td><td id="dataNilai">rieqyns13</td></tr>
