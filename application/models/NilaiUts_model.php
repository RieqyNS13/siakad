<?php 
class NilaiUts_model extends CI_Model{
	...
	function total($arr=null){
		...
		if($arr!=null){
			...
			foreach($arr as $key=>$mbuh){
				if(!is_null($mbuh)){
					if($key=="nilai_uts_6771.kd_mapel" && $mbuh==="00"){
		...
		$this->db->join("siswa_6771","siswa_6771.nis=nilai_uts_6771.nis");
		return $this->db->get("nilai_uts_6771")->num_rows();
	}
	function getData($start,$limit,$arr=null){
		...
		$this->db->select("*,concat(nilai_uts_6771.semester,' (',IF(nilai_uts_6771.semester=1,'Ganjil','Genap'),')') as semester2,concat(kelas_6771.prefix_kelas,' ',jurusan_6771.nama_jurusan,' ',kelas_6771.nomor_kelas) as kelas");
		$this->db->from("nilai_uts_6771");
		$this->db->join("siswa_6771","siswa_6771.nis=nilai_uts_6771.nis");
		...
		$this->db->join("mapel_6771","mapel_6771.kode_mapel=nilai_uts_6771.kd_mapel");
		$this->db->where($where);
		//$this->db->join("kelas_6771","kelas_6771.id_kelas=siswa_6771.kd_kelas");
	...
	function cariData($q,$start,$limit){
		$this->db->select("siswa_6771.*,mapel_6771.*,nilai_uts_6771.*,guru_6771.nama as nama_guru,concat(nilai_uts_6771.semester,' (',IF(nilai_uts_6771.semester=1,'Ganjil','Genap'),')') as semester2,concat(kelas_6771.prefix_kelas,' ',jurusan_6771.nama_jurusan,' ',kelas_6771.nomor_kelas) as kelas");
		$this->db->from("nilai_uts_6771");
		$this->db->join("siswa_6771","siswa_6771.nis=nilai_uts_6771.nis");
		$this->db->join("mapel_6771","mapel_6771.kode_mapel=nilai_uts_6771.kd_mapel");
		$this->db->join("kelas_6771","kelas_6771.id_kelas=siswa_6771.kd_kelas");
		$this->db->join("jurusan_6771","jurusan_6771.id_jurusan=kelas_6771.kd_jurusan");
		$this->db->join("guru_6771","guru_6771.kode_guru=nilai_uts_6771.kd_guru_penilai");
		...
		$this->db->or_having("nilai_uts_6771.semester like '%".$q2."%'");
		$this->db->or_having("nilai_uts_6771.tahun_ajaran like '%".$q2."%'");
		$this->db->or_having("nilai_uts_6771.nilai like '%".$q2."%'");
	...
	function cekNilaiUas($arr){
		$get=$this->db->get_where("nilai_uts_6771",$arr);
	...
	function getNilai(){
		...
		$this->db->select("nilai_uts_6771.*,siswa_6771.*,mapel_6771.*,guru_6771.nama as namaguru,concat(nilai_uts_6771.semester,' (',IF(nilai_uts_6771.semester=1,'Ganjil','Genap'),')') as semester2");
		$this->db->from("nilai_uts_6771");
		$this->db->join("siswa_6771","siswa_6771.nis=nilai_uts_6771.nis");
		$this->db->join("mapel_6771","mapel_6771.kode_mapel=nilai_uts_6771.kd_mapel");
		$this->db->join("guru_6771","guru_6771.kode_guru=nilai_uts_6771.kd_guru_penilai");
		$this->db->where("nilai_uts_6771.id",$id);
		$get=$this->db->get();
	...
	function hapusData(){
		...
		if(empty($id))return array("error"=>"Parameter id kosong");
		$hapus=$this->db->delete("nilai_uts_6771",array("id"=>$id));
	...
	function editData(){
		...
		$update=$this->db->update("nilai_uts_6771",$post);
	...
	function inputData(){
		...
		$this->db->insert("nilai_uts_6771", $post);
