...
class Jurusan_model extends CI_Model{
	...
	function cekJurusanBelumAda($data){
		$query=$this->db->get_where("jurusan_6771",array("nama_jurusan"=>$data["nama_jurusan"]));
	...
	function editJurusan($post){
		$get=$this->db->get_where("jurusan_6771",array("id_jurusan"=>$post["id_jurusan_forEdit"]));
		if($get->num_rows()==0)return array("sukses"=>false,"msg"=>"Terjadi kesalahan pada data");
		$nama_jurusan=strtoupper($get->row()->nama_jurusan);
		if($nama_jurusan!==strtoupper($post["nama_jurusan"])){
