...
function editJurusan(kode){
	...
	$.ajax({
		url:'<?php echo site_url("admin/lihatDetailJurusan"); ?>',
		type:'post',
...
$(function(){
	...
	$("#konfirmHapus").click(function(){
		$.ajax({
			url:'<?php echo site_url("admin/hapusJurusan"); ?>',
			type:'post',
	...
	$("#modalLog").on("hidden.bs.modal",function(e){
		if($("body").data("isRefresh")==true)window.location.reload();
				...
				<div class="row">
				<div class="col-lg-8">
				 <form class="form-inline" id="gantiPaging" method="post" action="<?php echo site_url("admin/gantiPagingJurusan"); ?>">
			...
			<form id="frmCari" method="get" action="<?php echo site_url("admin/dataJurusan"); ?>">
			 <div class="col-lg-4">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
								   ...
								   foreach($dataJurusan as $data){
									   ...
									   echo "<tr><td>$a</td><td id=\"data".$a."\">".$data->nama_jurusan."</td><td>".$data->nama_full."</td><td>".$data->kode_diklat."</td><td><a href=\"#\" onclick=\"return editJurusan('".addslashes($data->id_jurusan)."')\"><span class=\"glyphicon glyphicon-pencil\"></span> Edit</a> | <a href=\"#\" onclick=\"return hapusJurusan('".addslashes($data->id_jurusan)."','data".$a."')\"><span class=\"glyphicon glyphicon-trash\"></span> Hapus</a></td></tr>";
									   $a++;
								   }
								   ?>
                                </tbody>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalTambahJurusan">
  <div class="modal-dialog">
	...
	<form id="frmTambahJurusan" method="post" action="<?php echo site_url("admin/submitJurusan"); ?>">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalEditJurusan">
  <div class="modal-dialog">
    <div class="modal-content">
	<form id="frmEditJurusan" method="post" action="<?php echo site_url("admin/editJurusan"); ?>">
