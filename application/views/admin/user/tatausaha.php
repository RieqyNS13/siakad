...
function hapusMapel(id_user,username){
	...
	$("#modalHapusBody").html("Hapus akun tata usaha dengan username '"+username+"'?");
...
function editUser(id_user){
	...
	$.ajax({
		url:'<?php echo site_url("admin/user/getUser/tatausaha"); ?>',
		type:'post',
...
$(function(){
	...
	$("#konfirmHapus").click(function(){
		$.ajax({
			url:'<?php echo site_url("admin/user/hapusAkun/tatausaha"); ?>',
			type:'post',
	...
	$("#modalLog").on("hidden.bs.modal",function(e){
		if($("body").data("isRefresh")==true)window.location.reload();
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Tata Usaha
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<div class="row">
				<div class="col-lg-8">
				 <form class="form-inline" id="gantiPaging" method="post" action="<?php echo site_url("admin/user/gantiPaging/tatausaha"); ?>">
			...
			<form id="frmCari" method="get" action="<?php echo site_url("admin/user/show/tatausaha"); ?>">
			 <div class="col-lg-4">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalTambah">
  <div class="modal-dialog">
	...
	<form id="frmTambah" method="post" action="<?php echo site_url("admin/user/tambahUser/tatausaha"); ?>">
...
<div class="modal fade" tabindex="-1" role="dialog" id="modaleditUser">
  ...
  <div class="tab-content">
	...
	<form id="frmEdit" method="post" action="<?php echo site_url("admin/user/editProfil/tatausaha"); ?>">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
	...
	<form id="frmEdit2" method="post" action="<?php echo site_url("admin/user/editAkun/tatausaha_1"); ?>">
	  <input type="hidden" name="id_user_forEdit">
  ...
  <hr>
  <form id="frmEdit3" method="post" action="<?php echo site_url("admin/user/editAkun/tatausaha_2"); ?>">
	  <input type="hidden" name="id_user_forEdit">
   <div class="form-group">
    <label>Password</label>
    <input type="password" class="form-control" placeholder="Password" name="password">
