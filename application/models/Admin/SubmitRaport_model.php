...
class SubmitRaport_model extends CI_Model{
	...
	function isWalikelas(){
		...
		$this->db->join("kelas_6771","walikelas_6771.id_kelas=kelas_6771.id_kelas","left");
		$this->db->join("siswa_6771","siswa_6771.kd_kelas=kelas_6771.id_kelas","left");
	...
	function getData($start,$limit,$arr=null,$kelas=null){
		...
		$this->db->join("jurusan_6771","jurusan_6771.id_jurusan=kelas_6771.kd_jurusan");
		$this->db->join("mapel_6771","mapel_6771.kode_mapel=nilai_tugas_6771.kd_mapel");
		$this->db->join("submitraport_6771","submitraport_6771.nis=siswa_6771.nis and submitraport_6771.id_kelas=kelas_6771.id_kelas and nilai_tugas_6771.semester=submitraport_6771.semester and nilai_tugas_6771.tahun_ajaran=submitraport_6771.tahun_ajaran","left");
